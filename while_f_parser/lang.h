...
struct cmd {
  ...
  union {
    ...
    struct {struct expr_list * args; } NAT_RE;
    struct {struct expr_list * args; } IDENT_RE; 
    struct {struct expr_list * args; } BLANK_RE;
    struct {void * none; } BREAK;
    struct {void * none; } CONTINUE;
    struct {char * ret; } RETURN;
  } d;
};
...
struct glob_item {
  ...
  union {
    ...
    struct {struct cmd * body; } NAT_RE_DEF;
    struct {struct cmd * body; } IDENT_RE_DEF;
    struct {struct cmd * body; } BLANK_RE_DEF;
    struct {char * name; struct cmd * body; } KW_DEF;
    struct {char * name; struct cmd * body; } SYMBOL_DEF;
  } d;
};
